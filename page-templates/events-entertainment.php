        ...
        <div id="primary" class="template-events">
            ...
            <div id="content" role="main" class="wrapper">
                ...
                <div class="site-content">
                    ...
                    // end if the date query is not set?>
                                    ...
                                    <div class="inner-wrapper">
                                        ...
                                        <div class="row-2 bottom-blocks">
                                            <div class="col-1 ">
                                                ...
                                                <?php 
                                                // get rid of this and replace with company logo
                                                //elseif(!is_wp_error($premium_terms)&&is_array($premium_terms)&&!empty($premium_terms)):
